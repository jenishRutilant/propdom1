...
const API_CONST = {
    add_property: `${API_URL}/property/addProperty`,
    add_sub_property: `${API_URL}/property/addSubProperty`,
    view_property: `${API_URL}/property/listSubProperty`,
    create_property_data: `${API_URL}/tempProp/addProperty`,
